...
# + deactivate_on - An array of Connect application names or identifiers that should not be able 
#                  to order the SKUs for this product. May only be set if `type=good`
# + description - The product’s description
# + id - An identifier will be randomly generated by Stripe. You can optionally override this ID, 
#        but the ID must be unique across all products in your Stripe account
# + images - A list of up to 8 URLs of images for this product, meant to be displayable to the customer
# + name - The product’s name
# + package_dimensions - The dimensions of this product for shipping purposes. May only be set if `type=good`
# + shippable - Specifies whether this product is shippable. May only be set if `type=good`
